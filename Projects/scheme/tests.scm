...
;;; Start adding test (from problem 6 to end)
;;; **********************************

;;; New Extra Test Cases
...
(begin '(* 5 10) (define x 3))
; expect x

(define x (begin (quote 3 ) (+ 1 2)))
x
; expect 3
